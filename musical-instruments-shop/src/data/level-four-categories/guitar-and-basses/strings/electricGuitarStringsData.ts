  ...
  subcategories: [
    {
      ...
      items: getProductsByCategory("0.08 electric guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("0.09 electric guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("0.10 electric guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("0.11 electric guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("7 strings electric guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("8 strings electric guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("12 strings electric guitar strings"),
    },
  ],
};
