  ...
  subcategories: [
    {
      ...
      items: getProductsByCategory("0.40 electric bass strings"),
    },
    {
      ...
      items: getProductsByCategory("0.45 electric bass strings"),
    },
    {
      ...
      items: getProductsByCategory("0.50 electric bass strings"),
    },
    {
      ...
      items: getProductsByCategory("5 strings electric bass strings"),
    },
  ],
};
