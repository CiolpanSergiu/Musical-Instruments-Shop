  ...
  subcategories: [
    {
      ...
      items: getProductsByCategory("0.10 acoustic guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("0.11 acoustic guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("0.12 acoustic guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("0.13 acoustic guitar strings"),
    },
    {
      ...
      items: getProductsByCategory("12 strings acoustic guitar strings"),
    },
  ],
};
