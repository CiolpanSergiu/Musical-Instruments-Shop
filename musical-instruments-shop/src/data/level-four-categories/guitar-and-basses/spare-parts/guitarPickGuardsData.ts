  ...
  subcategories: [
    {
      ...
      items: getStoreProducts("stratocaster guitar pick guard"),
    },
    {
      ...
      items: getStoreProducts("telecaster guitar pick guard"),
    },
    {
      ...
      items: getStoreProducts("les paul guitar pick guard"),
    },
    {
      ...
      items: getStoreProducts("doublecut guitar pick guard"),
    },
  ],
};
